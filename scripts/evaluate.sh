...
python llm_eval.py --model ../../train/ckpts/hf-llama-2-7b/int2-g128/checkpoint-960/ --eval_tasks winogrande,hellaswag,arc_challenge,piqa --test_set --bits 2 --group_size 128 --quant_type int --num_fewshot 0 
